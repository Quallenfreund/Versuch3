package net.Quallenfreund.tutorialmod.datagen;

import net.Quallenfreund.tutorialmod.TutorialMod;
import net.Quallenfreund.tutorialmod.block.ModBlocks;
    ...
    private static <T extends AbstractCookingRecipe> void oreCooking(
        ...
        for (ItemLike itemlike : pIngredients){
            SimpleCookingRecipeBuilder
                    .generic(Ingredient.of(new ItemLike[]{itemlike}), pCategory, pResult,
