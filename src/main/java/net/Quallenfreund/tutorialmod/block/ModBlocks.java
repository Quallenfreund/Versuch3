package net.Quallenfreund.tutorialmod.block;

import net.Quallenfreund.tutorialmod.TutorialMod;
import net.Quallenfreund.tutorialmod.item.ModItems;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> DEEPSLATE_SAPPHIRE_ORE = registerBlock("sapphire_ore",
            () -> new DropExperienceBlock (UniformInt.of(3, 7), BlockBehaviour.Properties.ofFullCopy(Blocks.DEEPSLATE)
                    .strength(3f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> NETHER_SAPPHIRE_ORE = registerBlock("sapphire_ore",
            () -> new DropExperienceBlock (UniformInt.of(3, 7), BlockBehaviour.Properties.ofFullCopy(Blocks.NETHERRACK)
                    .strength(1f).requiresCorrectToolForDrops()));
    public static final RegistryObject<Block> END_STONE_SAPPHIRE_ORE = registerBlock("sapphire_ore",
