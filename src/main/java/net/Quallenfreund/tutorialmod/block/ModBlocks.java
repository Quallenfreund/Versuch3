...
import net.Quallenfreund.tutorialmod.block.custom.SoundBlock;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> END_STONE_SAPPHIRE_ORE = registerBlock("end_stone_sapphire_ore",
            () -> new DropExperienceBlock (UniformInt.of(3, 8), BlockBehaviour.Properties.ofFullCopy(Blocks.END_STONE)
